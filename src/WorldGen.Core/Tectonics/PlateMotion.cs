...
namespace WorldGen.Core.Tectonics
{
    ...
    public static class PlateMotion
    {
        ...
        public static void GenerateEulerPole(ulong worldSeed, int plateId, out double x, out double y, out double z)
            => GenerateEulerPole(worldSeed, (ulong)plateId, out x, out y, out z);

        /// <summary>ND-45: ulong plateId-t is elfogad (a lemez-eletciklus gyermek-lemezei opak 64-bites ID-t kapnak).</summary>
        public static void GenerateEulerPole(ulong worldSeed, ulong plateId, out double x, out double y, out double z)
        {
            DeterministicRandom.SampleUnitVector3(
                worldSeed, RandomDomain.Tectonics, plateId, 0,
        ...
        public static double GenerateAngularVelocity(ulong worldSeed, int plateId)
            => GenerateAngularVelocity(worldSeed, (ulong)plateId);

        /// <summary>ND-45: ulong plateId-t is elfogad (gyermek-lemezek).</summary>
        public static double GenerateAngularVelocity(ulong worldSeed, ulong plateId)
        {
