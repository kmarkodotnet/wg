...
| **M4** | **Geológia + domborzat** | Lemezek, kéreg, elevation, tengerszint | Kontinensek, óceánok, árnyékolt hegyek | ✅ **Vizuálisan megerősítve** — `TEST-EARTH-001` numerikusan is teljesítve (234/234 teszt). A §13.2 fraktál-zaj korábbi hiánya (Voronoi-cella-szerű szabályosság) ✅ **pótolva** (ND-31, térben koherens fBm) — vizuális újra-ellenőrzés Unityben még hátra. |
