...
| A9 🟡 | **Tó-blokkosság** | Az ND-49/ND-124 a FOLYÓ-vonalat vitte finom nyomvonalra; a **tavak** továbbra is a régi, referencia-szintű mechanizmussal rajzolódnak, rájuk a javítás nem vonatkozik. Önálló diagnózist igényel, ha a képen zavaró (→ B3). | ND-49, backlog M9/M7 |
...
| B3 👁 | **Folyó- és tó-hálózat vizuális elfogadása** | Play → zoom egy nagy kontinens folyóhálózatára. A finomított vonalak háttérszálon készülnek (~30 s, 96 forrás). Fának látszik-e? Elég sűrű-e? A **tó**-blokkosság zavaró-e? | A metrikák javultak (összefolyás 8 → 40, max vízhozam-súly 2 → 6, „súly ≥ 3" 0 → 13), de hogy a képernyőn fa-e, azt nem én ítélem meg. Válasz → A8, A9. |
