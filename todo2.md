...
| A5 🟠 | **Deep-time variancia és allokációprofil** | **FOLYAMATBAN (2026-09-22, ND-133).** Friss baseline: 12 meleg Build átlaga **2479 ms**, szórása **121 ms**; mesh **159–580 ms**, bucket-előkészítés **19–315 ms**, emit **247–277 ms**. Megismételhető logelemző és kapcsolható statikus fázismérés (főszálú allokáció, GC-számlálók, nettó heap, Unity Profiler-minták) elkészült. Első élő próba: a lassú bucket-fázis alatt GC történt; a Mono allokációszámlálója nem működik, ezt a mérő külön jelzi. A különböző világidők eltérő munkát jelentenek; a GC-szünet és a worker/native költség még mérendő. Az A4 lezárása után önálló diagnosztikai tétel. | ND-133, [mérés és protokoll](history/2026-09-22-deep-time-allocation-profile.md) |
